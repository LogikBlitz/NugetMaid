...
using InfomediaAS.VS_Extensions.Commands.Nuget;
...
namespace InfomediaAS.VS_Extensions
{
    ...
    [Guid(GuidList.guidVS_ExtensionsPkgString)]
    public sealed class VS_ExtensionsPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if (null != mcs)
            {
                ...
                CreateNugetCommands(mcs, uiShell);
            }
        }

        #endregion

        #region Init commands as tey are represented in their respective groups

        internal void CreateNugetCommands(OleMenuCommandService commandService, IVsUIShell uiShell)
        {
